...
/**
 * Servlet implementation class ProductListDeleteServler
 */
@WebServlet("/listDelete.pro")
public class ProductListDeleteServler extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ProductListDeleteServler() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//------------페이징 처리 추가-------------------
				...
				if(pList != null) {
					view = request.getRequestDispatcher("views/product/prodcutDeleteView.jsp");
