 ...
 * urlPatterns : 어떠한 서블릿을 가기 전에 실행될 것인지를 지정 --> /*로 지정하게 되면 모든 서블릿을 뜻한다
 */
...
public class CommonFilter implements Filter {
     ...
     * 					ServletRequest, ServlerResponse, FilterChain 객체
     * 
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
		...
		request.setCharacterEncoding("UTF-8");	// 지금까지 서블릿마다 적었던 것을 여기 한 번만 적으면 됨
