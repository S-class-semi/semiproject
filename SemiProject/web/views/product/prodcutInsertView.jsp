...
<%@ include file = "/views/company/companyMenubar.jsp" %> 
		<div id="centerbody">
		<form action="<%=request.getContextPath() %>/insert.pro" method="post" encType = "multipart/form-data" onsubmit="return productcheck()">
		<div  id="proinfotable">
		<h1 id="inserttext">상품 등록</h1>
			...
			<div id = "titleImgArea">
				...
				<tr>
					...
					<td><input name="p_code" id ="p_code1" type="text"></td>
					<td><div id = "p_codeCheck"></div></td>
				</tr>
				<tr>
				...
				<tr>
					<td>상품명 :</td>
					<td><input type="text" name="p_name" id="p_name1"></td>
					<td>상품 가격:</td>
					<td><input type="text" name="p_price" id="p_price1"></td>
				</tr>
				<tr>
				<td>내용 사진 기재</td>
				<td>
				...
				<tr>
				<td colspan="4">
				<textarea rows="10" cols="100%" name ="p_info" id="p_info1"></textarea>
				</td>
				</tr>
							...
							if(!p_codeCK.test(p_code.val())){
								...
								$.ajax({
									...
									data:{
										...
										if(data == "fail"){
											$("#p_codeCheck").html('');
											$("#p_codeCheck").html("이미있는 상품 코드입니다.").css("color","red");
											p_codeflg = false;
											console.log(p_codeflg);
