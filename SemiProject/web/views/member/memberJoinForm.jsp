   ...
   <div class = "outer">
      ...
      <form id="joinForm" action="<%=request.getContextPath()%>/insert.me" method="post" onsubmit = "toEnabled()">
         <table align = "center">
            ...
            <tr>
               <td>
               <input id="space4" name="space" class="option-input radio" type="radio" value = "4" checked>
               <label for="space4">4평 이하</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
               <input id="space7" name="space" class="option-input radio" type="radio" value = "7">
               <label for="space7">5 - 7평</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
               <input id="space10" name="space" class="option-input radio" type="radio" value = "10">
               <label for="space10">8 - 10평</label><br>
               <input id="space13" name="space" class="option-input radio" type="radio" value = "13">
               <label for="space13">11 - 13평</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
               <input id="space15" name="space" class="option-input radio" type="radio" value = "15">
               <label for="space15">14 - 15평</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
               <input id="space16" name="space" class="option-input radio" type="radio" value = "16">
               <label for="space16">16평 이상</label>
               </td>
            </tr>
         </table>
         <br><br><br>
